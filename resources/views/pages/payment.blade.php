			...
			<div class="headingWrap">
                ...
                {{ csrf_field() }}
                    <div class="form-group">
                        <input type="radio" name="payment_method" value="handcash"> Hand Cash </input>
                    </div> 
                    <div class="form-group">
                        <input type="radio" name="payment_method" value="cart"> Debid card </input>
                    </div>
                    <div class="form-group">
                        <input type="radio" name="payment_method" value="payple"> B-kash </input>
                    </div>
