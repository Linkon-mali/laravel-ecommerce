					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="{{url('/admin_logout')}}"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{url('/all_catagory')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Catagory</span></a></li>
						<li><a href="{{url('/add_catagory')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Catagory</span></a></li>
						<li><a href="{{url('/all_manufacture')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Manufacture</span></a></li>
						<li><a href="{{url('/add_manufacture')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Manufacture</span></a></li>
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{url('/add_product')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Product</span></a></li>
							</ul>	
						</li>
						<li>
						...
						<li><a href="{{url('/manage_order')}}"><i class="icon-list-alt"></i><span class="hidden-tablet"> Manage Order</span></a></li>
						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet"> Shope Name</span></a></li>
						<li><a href="table.html"><i class="icon-align-justify"></i><span class="hidden-tablet"> Dalevary Man</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
