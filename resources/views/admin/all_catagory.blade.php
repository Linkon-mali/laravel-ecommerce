				...
				<div class="box span12">
					...
					@foreach($allcatagory_info as $v_catagory) 
					  ...
					  <tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="odd">
								<td class="  sorting_1">{{ $v_catagory->catagory_id }}</td>
								<td class="center ">{{ $v_catagory->catagory_name }}</td>
								<td class="center ">{{ $v_catagory->catagory_description }}</td>
								<td class="center ">

								 @if( $v_catagory->publication_status == 1 )
								...
								<td class="center ">
								@if( $v_catagory->publication_status == 1)
									<a class="btn btn-danger" href="{{url('/unactive_catagory/'.$v_catagory->catagory_id)}}">
										<i class="halflings-icon white thumbs-down"></i>                                            
									</a>
									@else
									<a class="btn btn-success" href="{{url('/active_catagory/'.$v_catagory->catagory_id)}}">
										<i class="halflings-icon white thumbs-up"></i>                                            
									</a>

									@endif
									<a class="btn btn-info" href="{{url('/edit_catagory/'.$v_catagory->catagory_id)}}">
										<i class="halflings-icon white edit"></i>                                            
									</a>
									<a class="btn btn-danger" href="{{url('/delete_catagory/'.$v_catagory->catagory_id)}}">
