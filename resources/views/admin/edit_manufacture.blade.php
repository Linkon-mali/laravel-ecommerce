			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/update_manufacture/'.$allmanufacture_info->manufacture_id)}}" method="post">
                            {{ csrf_field() }}
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" id="date01" name="manufacture_name" value="{{$allmanufacture_info->manufacture_name}}">
							  </div>
							</div>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
                                ...
                                {{$allmanufacture_info->manufacture_description}}
                                </textarea>
							  </div>
                            </div>
