						...
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<?php 
									...
									<li><a href="{{url('/coustomer_logout')}}"><i class="fa fa-lock"></i>Logout</a></li>
									<?php }else {?>
									<li><a href="{{url('/login_check')}}">Login</a></li>
								<?php }?>
							</ul>
						</div>
					</div>
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="{{url('/payment')}}">Checkout</a></li>
											<?php }else {?>
										<li><a href="{{url('/login_check')}}">Checkout</a></li>
										<?php }?>
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="{{url('/productby_catagory/'.$v_catagory->catagory_id)}}">{{$v_catagory->catagory_name}}</a></h4>
								</div>
							</div>
								<?php } ?>
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
					            ...
					            foreach($all_published_manufacture as $v_manufacture) {?>
									...
									<li><a href="{{url('/productby_manufacture/'.$v_manufacture->manufacture_id)}}"> <span class="pull-right">(50)</span>{{$v_manufacture->manufacture_name}}</a></li>
